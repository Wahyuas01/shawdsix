...
2. Buka **SQL Editor**, jalankan **berurutan**:
   ...
   8. `supabase/008_screenshot_duty.sql` (screenshot On Duty & Off Duty di Log Duty Mekanik)
   9. `supabase/009_lamaran_mekanik.sql` (modul Lamaran Mekanik: UCP, Nama IC, Umur, Family, 3 screenshot — satu lamaran aktif per warga)
