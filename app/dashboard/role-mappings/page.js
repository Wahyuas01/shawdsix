...
const FIELDS = [
  ...
  { name: 'label', label: 'Label', type: 'text', placeholder: 'cth. Mekanik Gravencio' },
  {
    name: 'type', label: 'Tipe', type: 'select',
    options: ['member_workshop', 'admin_workshop', 'super_admin'],
  },
  ...
  return (
    <div className="space-y-4">
      <div className="bg-blue-50 text-brandblue-700 text-sm rounded-xl p-4">
        ...
        Contoh: role Discord &quot;Mekanik Gravencio&quot; dipetakan ke tipe <code>member_workshop</code> dengan Workshop = &quot;Gravencio Workshop&quot; — begitu anggota dengan role itu klik &quot;Sinkron Role&quot; di Profil, dia otomatis kecatat sebagai mekanik.
      </div>
